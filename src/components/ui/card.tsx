...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>((
  ...
  <div
    ref={ref}
    className={cn("rounded-4xl border bg-card text-card-foreground shadow-lg", className)}
    {...props}
  />
))
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>((
  ...
  <h3 ref={ref} className={cn("font-heading text-3xl font-bold leading-none tracking-tight", className)} {...props} />
))
